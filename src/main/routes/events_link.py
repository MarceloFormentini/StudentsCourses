...
def create_new_link():
	...
	events_link_creator = EventsLinkCreator(eventos_link_repository=eventos_link_repository)

	http_request = HttpRequest(body=request.json)
	http_response = events_link_creator.create(http_request=http_request)
